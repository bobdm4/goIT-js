...
//     присвой). Пользователь решает купить ремонтных дроидов, которые стоят по 3000 кредитов за 
//     штуку. Цена одного дроида хранится в переменной pricePerDroid (создай и присвой).
...
// const order = prompt('Сколько дронов купить?');
// let totalPrice = pricePerDroid * order;
// let message;
// let charge = credits - totalPrice;
...
// } else {
//     message = 'Вы купили' + order + ' дроидов, на счету осталось ' + charge + ' кредитов.';
// }
